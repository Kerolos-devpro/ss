...
namespace Test.Controllers
{
    public class MyAccountController : Controller
    {
        ...
        public IActionResult MyReviews()
        {
            ...
            {
                TempData["ErrorMessage"] = "You must log in and purchase product to add any review.";
        ...
        public IActionResult Delete(int id)
        {
            if (!User.Identity.IsAuthenticated)
            {
                TempData["ErrorMessage"] = "You must log in and purchase product to delte any review.";
                return RedirectToAction("Index", "Home");
            }
        ...
        public IActionResult BestSellerProducts()
        {
            if (!User.Identity.IsAuthenticated)
            {
                TempData["ErrorMessage"] = "You must log in to see the best seller product.";
                return RedirectToAction("Index", "Home");
            }
        ...
        public IActionResult AvailableCouponCode()
        {
            if (!User.Identity.IsAuthenticated)
            {
                TempData["ErrorMessage"] = "You must log in and to see available coupon.";
                return RedirectToAction("Index", "Home");
            }
